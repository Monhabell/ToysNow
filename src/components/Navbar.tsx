        ...
        <div className="max-w-7xl mx-auto px-4 py-3 flex flex-col md:flex-row md:justify-between md:items-center">
          ...
          <div className="hidden md:flex items-center">
            <Link href="/carrito" className="relative group">
              <ShoppingBag className="w-6 h-6" />
              <span className="absolute -top-2 -right-2 bg-magenta-600 text-white text-xs rounded-full h-5 w-5 flex items-center justify-center group-hover:bg-magenta-700 transition-colors">0</span>
            </Link>
          </div>
        </div>
      </div>
