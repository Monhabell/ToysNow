      ...
      <div className="relative bg-black min-h-screen mt-42 sm:mt-30">
        ...
        <div className="overflow-hidden">
          ...
          <div className="bottom-10 sm:bottom-20 left-0 right-0 text-center z-2 px-4">
            <h1 className="text-2xl sm:text-3xl font-bold text-gold-600 mb-4 mt-5">
              ToysNow - Juguetes Íntimos Premium
            </h1>
            <div className='mr-5'>
              <Category />
            </div>
            ...
            {productoDestacado2 && (
              <section className="relative rounded-xl sm:rounded-2xl overflow-hidden mb-12 sm:mb-20 h-[350px] sm:h-[500px]">
                ...
                <div className="absolute left-4 sm:left-10 top-1/2 -translate-y-1/2 z-2 max-w-xs sm:max-w-md px-2 sm:px-0">
                  ...
                  <Link
                    href={`/productos/${productoDestacado2.slug}`}
              ...
              <div className="mt-6 grid grid-cols-1 md:grid-cols-2 gap-8 text-white">
                <div className="space-y-6">
                  ...
                  <p className="text-gray-300 leading-relaxed">
                    ...
                    ToysNow, están diseñados para explorar sensaciones, mejorar la intimidad y descubrir nuevas
                    dimensiones del placer personal y en pareja.
                  </p>
                  <p className="text-gray-300 leading-relaxed">
                    Contrario a los tabúes sociales, el uso de juguetes sexuales contribuye al autoconocimiento
                    corporal, ayuda a reducir el estrés mediante la liberación de endorfinas, y puede mejorar
                    significativamente las relaciones íntimas al incorporar elementos de novedad y exploración
                    mutua.
                  </p>
                </div>

                <div className="space-y-6">
                  <h3 className="text-xl font-semibold text-pink-400">Calidad y seguridad primero</h3>
                  <p className="text-gray-300 leading-relaxed">
                    En ToysNow seleccionamos cuidadosamente cada producto priorizando materiales de alta calidad
                    como silicona médica, ABS libre de ftalatos y acero inoxidable quirúrgico. Estos materiales
                    no solo garantizan durabilidad sino también seguridad para tu cuerpo, siendo hipoalergénicos
                    y fáciles de limpiar.
                  </p>
                  <p className="text-gray-300 leading-relaxed">
                    Nuestra curación de productos sigue estrictos protocolos de calidad, asegurando que cada
                    artículo cumpla con los estándares internacionales de fabricación. Trabajamos directamente
                    con fabricantes certificados para brindarte la mejor experiencia sensual sin comprometer
                    tu bienestar.
                  </p>
                </div>
              </div>
              ...
              <div className="mt-8 bg-gray-900/50 rounded-xl p-6 border border-pink-500/20">
                ...
                <ul className="grid grid-cols-1 md:grid-cols-2 gap-4 text-gray-300">
                  <li className="flex items-start">
                    ...
                    Siempre limpia tus productos antes y después de cada uso con agua y jabón suave
                  </li>
                  <li className="flex items-start">
                    <span className="text-pink-400 mr-2">•</span>
                    Almacena en un lugar fresco y seco, preferiblemente en su estuche original
                  </li>
                  <li className="flex items-start">
                    <span className="text-pink-400 mr-2">•</span>
                    Utiliza lubricantes a base de agua para compatibilidad con todos los materiales
                  </li>
                  <li className="flex items-start">
                    <span className="text-pink-400 mr-2">•</span>
                    Revisa regularmente el estado de tus productos y reemplázalos si muestran desgaste
                  </li>
                </ul>
              </div>
            </section>
          ...
          <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="space-y-4">
              ...
              <p className="text-gray-300">
                ...
                y educación sexual para una experiencia integral.
              </p>
            </div>
